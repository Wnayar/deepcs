...
| know what phase 6 adds | Part 8 | 5 min |
...
The intended chain, once phase 6 exists:
...
| | Local development | Production (phase 6) |
|---|---|---|
...
pushed anywhere and nothing is deployed yet**; steps 2 and 3 above are phase 6,
...
arrive as Cloud Run secrets in phase 6.
...
phase 6 adds the deploy step, you recognise the shape. The key thing to
